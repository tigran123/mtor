...
to one such application, made by myself (then a postgraduate theoretical physicist) independently and many years \emph{prior} of learning about Eddington's research.
...
The resulting ``Quantum Economics'' scheme was described in a very brief paper, which I called ``On the New Method of Price Forecasting'' and showed it to the two economists from the UK,
