...
points in four\hyp{}dimensional Euclidean space, the coordinates $(y_{1}, y_{2}, y_{3}, y_{4})$ and
...
and of time\hyp{}reckoning $(x_{1}, x_{2}, x_{3}, x_{4})$ and that the geometry of these is given by
\[
